...
namespace UniMvvm.Effects
{
    public static class LineColorEffect
    {
        ...
        {
            public EntryLineColorEffect() : base("Grabzi.Moblie.EntryLineColorEffect")
            {
            }
        }
        ...
        {
            public DatePickerLineColorEffect() : base("Grabzi.Moblie.DatePickerLineColorEffect")
            {
            }
        }
        ...
        {
            public PickerLineColorEffect() : base("Grabzi.Moblie.PickerLineColorEffect")
            {
            }
        }
    }
